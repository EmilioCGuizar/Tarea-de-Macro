---
title: "Macroeconomía II: Mercados Laborales (Tarea #1)"
author: 
...
## Ejercicio 3
\begin{enumerate}
\item[] \textbf{3. Contraste un modelo trivial de la determinación del salario con los datos siguiendo estos pasos:}
\end{enumerate}

### a)
\begin{enumerate}
\item[] \textit{Obtenga una serie del PIB $Y_t$ de la economía.}
\end{enumerate}
\textbf{Solucion: }
...
### b)
\begin{enumerate}
\item[] \textit{Obtenga una serie del capital $K_t$ de la economía (``Indice de Volumen físico acumulado´´).}
\end{enumerate}
\textbf{Solucion: }
...
### c)
\begin{enumerate}
\item[] \textit{Obtenga una serie del empleo $L_t$ de la economía.}
\end{enumerate}
\textbf{Solucion: }
...
```{r fig.cap='Procuto, Capital y Trabajo (2008-2021)', fig.pos = 'H'}
...
### d)
\begin{enumerate}
\item[] \textit{Cree una serie de la productividad $A_t$ de la economía a partir de asumir una función de producción $Y_t=A_tF(K,L)$, con $F(K,L)=K^{0.3}L^{0.7}$.}
\end{enumerate}
\textbf{Solucion: }
...
### e)
\begin{enumerate}
\item[] \textit{Cree una serie contrafactual del salario que se debió de haber observado si el salario fuera el ingreso marginal del trabajo $A_tF_L(K_t,L_t)$.}
\end{enumerate}
\textbf{Solucion: }
$$
...
### f) 
\begin{enumerate}
\item[] \textit{Compare el salario observado con el salario contrafactual a la luz de los hechos estilizados y las teorías descritas en clase.}
\end{enumerate}
\textbf{Solucion: }
...
En un primer acercamiento, esta gráfica sugiera una relación clara entre el salario y el nivel de informalidad por sector: a menor nivel de informalidad, mayor nivel de salario diario.
...
```{r fig.cap="Búsqueda de otro Empleo, 2019"}
